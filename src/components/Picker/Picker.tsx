...
import { Button, PageHeader, Modal, Typography } from 'antd';
...
const Picker: React.FC<Props> = (props) => {
  ...
  const showUploadModal = (fileId: Key, fileName: string) => confirm({
    title: 'Do you want to upload this file?',
    icon: <QuestionCircleOutlined />,
    content: 'If you click "OK" button this file will be upload to your s3 bucket',
    centered: true,
    onOk: () => handleDownload(fileId, fileName),
  });
